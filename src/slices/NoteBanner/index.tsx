...
const NoteBanner: FC<NoteBannerProps> = ({ slice }) => {
  ...
  const signature =
    slice.primary.signature ||
    (name ? `С любовью во Мессии, ${name}` : "С любовью во Мессии");
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-10 lg:grid-cols-[auto_1fr] lg:items-start lg:gap-16">
            ...
            <div className="relative">
              ...
              {signature && (
                <p className="mt-6 text-sm font-medium italic text-zinc-400 dark:text-zinc-500 sm:mt-8">
                  {signature}
                </p>
              )}

              {isFilled.keyText(slice.primary.buttonText) &&
