  ...
  return (
    <>
      <button
        ...
        className="hidden lg:inline-flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 text-zinc-600 hover:bg-zinc-100 transition-colors cursor-pointer"
      ...
      {mounted &&
        createPortal(
          <div
            className={cn(
              "fixed inset-0 z-[100] flex flex-col bg-white transition-all duration-300 ease-in-out",
          ...
          >
              ...
              <div className="flex items-center justify-between px-6 py-4 max-w-[1800px] mx-auto w-full">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="inline-flex h-10 px-4 items-center justify-center rounded-full border border-zinc-200 text-zinc-900 hover:bg-zinc-100 transition-colors cursor-pointer"
                  >
                    Закрыть
            ...
            <div className="flex-1 flex overflow-hidden max-w-[1800px] mx-auto w-full">
              ...
              {/* Commentaries */}
              <div className="w-[400px] shrink-0 flex flex-col overflow-hidden bg-zinc-50/50">
                <div className="flex items-center gap-3 border-b border-zinc-200 px-6 py-5 shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-500">К текущему чтению</p>
                  </div>
                </div>
