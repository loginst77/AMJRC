        ...
        >
          ...
          <div className="relative flex flex-col items-center gap-6 p-8 sm:p-10 md:flex-row md:items-start lg:gap-8">
            ...
            <div className="flex flex-col justify-center md:w-[72%]">
              ...
              <p className="mb-8 max-w-2xl text-lg leading-relaxed text-zinc-600 dark:text-zinc-400 sm:text-xl">{book.description}</p>
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    {book.author ? (
                      <div className="flex items-center gap-4">
                        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-lg font-bold text-blue-700 ring-1 ring-blue-200 dark:bg-blue-900/50 dark:text-blue-300 dark:ring-blue-800">
