            ...
            >
              <div className="flex-1 px-5 py-8 sm:px-8 sm:py-12">
                <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-100 text-xl text-blue-900">
                  {card.IconComp ? <card.IconComp className="h-7 w-7" /> : card.iconText || "✦"}
                </div>
                <div className="mt-6">
                  <SectionHeader
                    title={card.title}
              ...
              {card.buttonLabel && card.href && (
                <Link
                  ...
                  className="group mt-auto flex w-full items-center justify-start gap-2 border-t border-zinc-200 px-5 py-6 text-sm font-medium uppercase tracking-wide text-zinc-600 transition-colors hover:bg-blue-100 hover:text-zinc-900 sm:px-8"
                >
                  {card.buttonLabel}
