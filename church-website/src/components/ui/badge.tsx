  ...
  "inline-flex items-center rounded-full font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:focus:ring-zinc-300",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-red-50 text-red-600 ring-red-500/20 hover:bg-red-50/80 dark:bg-red-900/40 dark:text-red-400 dark:ring-red-400/20",
      ...
      size: {
        ...
        sm: "px-4 py-1 gap-2 text-xs font-medium",
